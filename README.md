...
- **Open source** — [whatsapp-cloud-client](https://github.com/vorluno/whatsapp-cloud-client) · [ratchet](https://github.com/vorluno/ratchet) · [niiko-events](https://github.com/vorluno/niiko-events) — pulled out of niiko, not written to be published. Apache-2.0
